...
#ifndef STOCKFISH_NNUE_LAYERS_CLIPPED_RELU_H_INCLUDED
#define STOCKFISH_NNUE_LAYERS_CLIPPED_RELU_H_INCLUDED
...
#endif // STOCKFISH_NNUE_LAYERS_CLIPPED_RELU_H_INCLUDED
