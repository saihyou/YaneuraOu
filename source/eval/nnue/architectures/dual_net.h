#ifndef DUAL_NET_H_INCLUDED
#define DUAL_NET_H_INCLUDED
...
struct Network
{
  static constexpr Stockfish::Eval::NNUE::IndexType kTransformedFeatureDimensions = L1;
  ...
  std::int32_t Propagate(const TransformedFeatureType* transformedFeatures)
  {
    ...
    {
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(fc_0)::OutputBuffer fc_0_out;
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(ac_sqr_0)::OutputType ac_sqr_0_out[Stockfish::Eval::NNUE::ceil_to_multiple<IndexType>(FC_0_OUTPUTS * 2, 32)];
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(ac_0)::OutputBuffer ac_0_out;
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(fc_1)::OutputBuffer fc_1_out;
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(ac_1)::OutputBuffer ac_1_out;
      alignas(Stockfish::Eval::NNUE::CacheLineSize) typename decltype(fc_2)::OutputBuffer fc_2_out;
...
#endif // #ifndef DUAL_NET_H_INCLUDED
