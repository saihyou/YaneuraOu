...
inline IndexType HalfKA_vm<AssociatedKing>::MakeIndex(Square sq_k, BonaPiece p) {
  if (sq_k >= SQ_61) {
...
// 駒の情報を取得する
template <Side AssociatedKing>
inline void HalfKA_vm<AssociatedKing>::GetPieces(
...
template <Side AssociatedKing>
void HalfKA_vm<AssociatedKing>::AppendActiveIndices(
...
template <Side AssociatedKing>
void HalfKA_vm<AssociatedKing>::AppendChangedIndices(
    const Position& pos, Color perspective,
...
template class HalfKA_vm<Side::kFriend>;
template class HalfKA_vm<Side::kEnemy>;
